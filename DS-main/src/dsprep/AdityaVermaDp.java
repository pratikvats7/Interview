...
//        dsprep.RecursionAndBackTracking.displayBoard(dp16);
//        dsprep.RecursionAndBackTracking.displayBoard(dp15);
...
//        System.out.println(maxProfitStocks(prices,0,Integer.MAX_VALUE));
    ...
    private static void mathodCalls(){
        ...
        //System.out.println(dsprep.Solution.knapSack(41,weight,values,58));

        //int x =  knapSack01Dp(weight,values,41,58,dp);
        // dsprep.RecursionAndBackTracking.displayBoard(dp);
        ...
        //dsprep.RecursionAndBackTracking.displayBoard(dp2);
...
//        dsprep.RecursionAndBackTracking.displayBoard(dp6);
        int[][] dp6 = new int[7][8];
        ...
        //dsprep.RecursionAndBackTracking.displayBoard(dp7);
