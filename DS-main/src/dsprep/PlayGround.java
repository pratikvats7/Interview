...
//        targetSumSubsets(ar20,70,0,"");
        ...
        //KnightsTour(dsprep.RecursionAndBackTracking.chess,4,1,0);
        //printEncodings("pep",0);

//        for(int i=1;i<=9;i++) {
//            lexicographical(i, 100);
//        }
        //System.out.println(goldMine2(dsprep.RecursionAndBackTracking.goldMine));

        //sudoku(dsprep.RecursionAndBackTracking.sudoku,0,0);
